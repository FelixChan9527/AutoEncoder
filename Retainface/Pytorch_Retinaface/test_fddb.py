"""
# python test_fddb.py -m /home/MyServer/model_file/RetinaFace/Retinaface_model_v2/Resnet50_Final.pth --network resnet50
"""
...
save_path = "/home/MyServer/MyCode/Retainface/Pytorch_Retinaface/output/"
handsom_path = "/home/MyServer/data/RECOLA/video_frames/train_3/161_6440.jpg"
...
#########################################################
    ...
    # ignore low scores
    inds = np.where(scores > args.confidence_threshold)[0]
    # print("111->", args.confidence_threshold)
    boxes = boxes[inds]
    landms = landms[inds]
    scores = scores[inds]
